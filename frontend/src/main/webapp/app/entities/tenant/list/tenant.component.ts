...
export class TenantComponent implements OnInit {
  ...
  constructor(protected tenantService: TenantService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.tenants = [];
  ...
  trackId(_index: number, item: ITenant): number {
    return item.id!;
  }
  ...
  protected paginateTenants(data: ITenant[] | null, headers: HttpHeaders): void {
